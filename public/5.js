...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    onSubmit: function onSubmit() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('http://localhost:8000/api/login', formdata).then(function (res) {
        _this.$store.commit('switchIsLogged');

        _this.$store.commit('switchIsAdmin', Boolean(res.data.user.is_admin));
...
var render = function() {
  ...
  return _c("div", [
    !_vm.$store.getters.is_logged
      ? _c("div", { staticClass: "vue-tempalte" }, [
          _c("form", [
